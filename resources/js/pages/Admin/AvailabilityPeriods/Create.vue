<script setup lang="ts">
    ...
    import { index, store } from '@/routes/admin/availability-periods';
...
<template>
    <Head title="Create Availability Period" />
    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Create Availability Period</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Add a new availability period to your schedule.</p>
                </div>
            </div>
        </template>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <Select v-model="form.day_of_week" required>
                            <SelectTrigger>
                                <SelectValue placeholder="Select a day" :options="dayOptions" />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-4">
                        ...
                        <Button type="submit" :disabled="form.processing">
                            {{ form.processing ? 'Creating...' : 'Create Availability Period' }}
                        </Button>
                    </div>
                </form>
            </CardContent>
